...
from detectron2.projects.DensePose.densepose.engine import Trainer
from detectron2.projects.DensePose.densepose.modeling.densepose_checkpoint import DensePoseCheckpointer
