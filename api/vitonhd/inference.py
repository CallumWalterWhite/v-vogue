...
def build_args():
    ...
    parser.add_argument("--model_image", type=str, required=True)
...
def main(args):
    ...
    dataset: VITONHDSingleDataset = getattr(import_module("dataset"), config.dataset_name)(
    ...
    print(batch_size)
    dataloader = DataLoader(dataset, num_workers=1, shuffle=True, batch_size=batch_size, pin_memory=True)
