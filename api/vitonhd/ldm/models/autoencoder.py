...
from vitonhd.ldm.modules.diffusionmodules.model import Encoder, Decoder
from vitonhd.ldm.modules.distributions.distributions import DiagonalGaussianDistribution
...
class AutoencoderKL(pl.LightningModule):
    ...
    #     recon, _ = self(real_img)
    #     recon = recon.clamp(-1, 1)
    #     loss = F.mse_loss(recon.float(), real_img.clamp(-1, 1).float(), reduction="mean")
    #     return loss
